...
import { setContactInput, updateData,addData } from '../store/actions'
const Form = () => {
    ...
    const handleCheckbox = (pref) => {
      const isChecked = contact.checkbox.includes(pref);
          ...
          const checkboxListUpdate = isChecked ? contact.checkbox.filter(item => item !== pref) : [...contact.checkbox, pref];
        dispatch(setContactInput( {
    ...
    <div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            name="name"
            value={contact.name}
            onChange={(e)=>{dispatch(setContactInput({...contact,name:e.target.value}))}}
          />
          <br />
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e)=>{dispatch(setContactInput({...contact,phoneNumber:e.target.value}))}}
          />
          <br />
        ...
        <div className="form-group">
          ...
          <select
            name="city"
            id="city"
            onChange={(e)=>{dispatch(setContactInput({...contact,city:e.target.value}))}}
          >
        ...
        <div className="form-group">
          ...
          <input
            ...
            name="gender"
            value="male"
            onChange={(e)=>{dispatch(setContactInput({...contact,gender:e.target.value}))}}
        ...
        <div className="form-group">
          ...
          <input
            ...
            name="email"
            value={contact.email}
            onChange={(e)=>{dispatch(setContactInput({...contact,email:e.target.value}))}}
          />
          <br />
        ...
        <div className="form-group">
          ...
          <input
            ...
            max="2018-12-31"
            value={contact.date}
            onChange={(e)=>{dispatch(setContactInput({...contact,date:e.target.value}))}}
          />
        </div>
        <div className="form-group">
          <label>Course: </label>
        ...
        <div className="btn-form">
          ...
          <button onClick={(e)=>handleUpdate(e,contact)}  type="submit" id="save" className="btn-submit">
            update
          </button>
        </div>
      </form>
